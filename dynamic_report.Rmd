...
image_read("https://unsplash.com/photos/person-in-white-shoes-standing-on-gray-concrete-road-1pAwJiCD60c") %>%
  image_scale("500x400")
...
image_read("https://unsplash.com/photos/man-in-red-and-white-checkered-dress-shirt-wearing-black-fedora-hat-Oe3JidQ9UvU") %>%
  image_scale("500x400")
